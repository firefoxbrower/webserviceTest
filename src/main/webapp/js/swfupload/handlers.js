...
function SWFInit(inputObj) {
	...
	SWFUOBJ = new SWFUpload({
		prefix:_prefix,
		upload_url: "common.do?method=batchUpload&handler="+_handler+"&indexTable="+_indexTable+"&indexId=" + _indexId+_uploadurlparam,
		delete_url:"common.do?method=deleteFile&handler="+_handler+"&indexId="+ _indexId+_deleteurlparam,
		...
		// Button Settings
		button_image_url : TEMP_SYSTEM_WEB_ROOT+"/images/SmallSpyGlassWithTransperancy_17x18.png",
		...
		// Flash Settings
		flash_url : TEMP_SYSTEM_WEB_ROOT+"/js/swfupload/swfupload.swf",
