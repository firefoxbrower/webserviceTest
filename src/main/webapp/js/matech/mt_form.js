...
function mt_form_setRowValue(obj) {
	...
	if(funExists("mt_form_beforeSetRowValue")) {
	...
	if(funExists("mt_form_afterSetRowValue")) {
...
function mt_form_setRowValues(obj) {
	...
	if(funExists("mt_form_beforeSetRowValues")) {
	...
	if(funExists("mt_form_afterSetRowValues")) {
...
function mt_form_setValue(obj) {
	...
	if(funExists("mt_form_beforeSetValue")) {
	...
	if(funExists("mt_form_afterSetValue")) {
...
function mt_form_check_transfer(obj){
	var uuid = obj.value ;
	if(funExists("mt_form_grid_check")) { 
